...
%lowpass_freq=100000;
fs_r=1E4;
FIRLPF=dsp.LowpassFilter('SampleRate',fs_r,'FilterType','IIR','PassbandFrequency',1000,'StopbandFrequency',1200);
...
mdepth_probe=1E-2;
t=0:1/fs:10000E-6;
t_r=0:1/fs_r:10000E-6;
freq_sweep=(-100E3:1E3:100E3)+fsignal;
N = length(t);
noise=randn(1,N)*50;
frame=0;
...
E_signal=0.5*exp(1i*2*pi*(fc+noise*6+fsignal).*t);
...
axis([fstart/1E6 fstop/1E6 -150 -40]);
grid on
